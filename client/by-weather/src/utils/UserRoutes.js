export const sign = `${process.env.REACT_APP_rprsnSrvr}/user/create`
export const srvlogin = `${process.env.REACT_APP_rprsnSrvr}/user/login`
export const maintainLogged = `${process.env.REACT_APP_rprsnSrvr}/user/Reissuance`
